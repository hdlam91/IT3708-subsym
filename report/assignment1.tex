...
The bots only have these three behaviour so they don't know if the box has reached its location or not. This makes it so the bots runs for ever even though they've accomplished the task.
