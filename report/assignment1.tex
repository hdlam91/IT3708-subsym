...
What we decided to do was to count the number of iterations the bots were in the retrieval state. When it has been in retrieval state for 20 iterations the bot will start to move backwards and then spin for a certain amount of time. This added randomness will hopefully make the bots able to locate the other box after it has pushed the first box for a while.
