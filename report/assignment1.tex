...
\subsection{System}
The system consist is a webot simulation which uses a world file provided by the course stab. The world file consists of a "food"-box inside a closed  square arena (4 walls) with 7 e-pucks. The box is emitting light along with another global directional light.
