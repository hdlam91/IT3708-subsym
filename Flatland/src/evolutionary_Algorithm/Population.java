...
public class Population <T>{
	...
	public Population(int numberOfIndividuals, int requiredGenotypeSize, int requiredNumberOfBits, boolean initializeRandomly, int individualType){
		this.individuals = new ArrayList<Individual<T>>();
		for (int i = 0; i < numberOfIndividuals; i++) {
			this.individuals.add(getIndividualOfType(requiredGenotypeSize, requiredNumberOfBits, initializeRandomly, individualType));
		}
	...
	public Individual<T> getIndividualOfType(int requiredGenoTypeSize, int requiredNumberOfBits, boolean initializeRandomly, int IndividualType){
